                                ...
                                children: (
                                    <>
                                        <div className='flex justify-end'>
                                            <h4
                                                className='bg-blue-500 px-2 py-2 rounded-lg text-white font-bold cursor-pointer hover:bg-blue-600 duration-300 ease-in-out'
                            ...
                            },
                            {
                                ...
                                children: (
                                    <>
                                        <div className='flex justify-end'>
                                            <h4
                                                className='bg-red-500 px-2 py-2 rounded-lg text-white font-bold cursor-pointer hover:bg-red-600 duration-300 ease-in-out'
